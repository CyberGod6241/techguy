...
function About() {
  return (
    <div className="w-full max-w-[53rem] p-6 flex flex-col py-100px md:py-[158px] px-6 md:px-32 items-start gap-[25px] ">
      ...
      >
        <p className="text-[16px] font-normal  dark:text-zinc-300 md:tracking-[.01em] md:leading-[1.4em] text-[#5a5a5a]">
        ...
        <p className="text-[16px]  dark:text-zinc-300 font-normal md:tracking-[.01em] md:leading-[1.4em] text-[#5a5a5a]">
