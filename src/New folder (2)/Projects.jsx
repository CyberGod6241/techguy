        ...
        <div className="relative overflow-hidden w-full ">
          <div className="rfm-marquee-text flex py-6 gap-4 whitespace-nowrap items-center justify-center transition-all">
            <span>
              <FontAwesomeIcon
                icon={faNodeJs}
                className="mr-1 text-zinc-900  dark:text-zinc-300 font-extrabold"
              />
            </span>
            <span>
              <FontAwesomeIcon
                icon={faJsSquare}
                className="text-zinc-900  dark:text-zinc-300 font-extrabold"
              />
            </span>
            <span>
              <FontAwesomeIcon
          ...
          >
            <a href={item.link} target="_blank" rel="noopener noreferrer">
              ...
              <div className="px-7 pb-7">
                ...
                <p className="text-[#5a5a5a]  dark:text-zinc-300 text-[16px] line-clamp-2">
                  {item.description}
                </p>
                <button className="mt-5 bg-[#f2f2f2] hover:bg-[#e5e5e5] flex items-center rounded-[14px] px-[24px] py-[14px] text-[16px] font-normal text-black text-start no-underline transition-all duration-500 group hover:cursor-pointer">
