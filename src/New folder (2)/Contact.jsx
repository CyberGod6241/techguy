...
function Contact() {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-[32px] dark:text-white font-bold tracking-[-.03em] leading-[110%] text-black mb-[16px]">
          Get In Touch
        </h2>
        <p className="text-[16px]  dark:text-zinc-300 font-normal tracking-[.01em] leading-[1.6em] text-[#5a5a5a] mb-[32px] max-w-[600px]">
